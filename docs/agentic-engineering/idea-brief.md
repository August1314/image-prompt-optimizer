...
- Distribution and monetization decision: `docs/agentic-engineering/distribution-and-monetization.md`
...
- Users willing to install a local desktop tool and bring their own model API key.
...
- Do not assume a hosted SaaS billing and cloud inference model for the first cycle.
